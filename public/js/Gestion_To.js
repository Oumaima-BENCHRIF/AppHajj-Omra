...
$(document).ready(function () {
    ...
    // ******update To******
    $("#update_to").on("submit", function (e) {
        e.preventDefault();
        var $this = jQuery(this);
        var formData = jQuery($this).serializeArray();
        jQuery.ajax({
    ...
    // ******Delete tos******
    $("#delete_To").on("submit", function (e) {
        e.preventDefault();
        var $this = jQuery(this);
        var formData = jQuery($this).serializeArray();
        jQuery.ajax({
...
function table_Tos() {
    jQuery.ajax({
        ...
        success: function (responce) {
            // Je récupère la réponse du fichier PHP
            jQuery.each(responce.Liste_Tos, function (key, item) {
                $tabledata = responce.Liste_Tos;
            });

            var table = new Tabulator("#liste_Tos", {
                printAsHtml: true,
                printStyled: true,
                // height: 220,
                data: $tabledata,
