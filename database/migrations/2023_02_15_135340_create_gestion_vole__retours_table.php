...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_portal')->create('gestion_vole__retours', function (Blueprint $table) {
            $table->id();
            $table->longText('date_retour')->nullable();
    ...
    {
        Schema::connection('mysql_portal')->dropIfExists('gestion_vole__retours');
    }
};
