        ...
        return [
            ...
            'Gestion' => [
                ...
                'sub_menu' => [
                    'hotels_transports' => [
                        'icon' => '',
                        'route_name' => 'hotel_transports.index',
                        'params' => [
                            'layout' => 'side-menu'
                        ],
                        'title' => 'G.hotels transports'
                    ],
                    'Accompagnateurs' => [
                        'icon' => '',
                        'route_name' => 'Accompagnateurs.index',
                        'params' => [
                            'layout' => 'side-menu'
                        ],
                        'title' => 'G.Accompagnateurs'
                    ],
                    'Agents' => [
                        'icon' => '',
            ...
            'gestion_dossier' => [
                ...
                'sub_menu' => [
                    'categories' => [
                        'icon' => '',
                        'route_name' => 'gestion_dossier.index',
                        'params' => [
                            'layout' => 'side-menu'
                        ],
                        'title' => 'Gestion Dossier'
                    ],
                    'add-product' => [
                        'icon' => '',
