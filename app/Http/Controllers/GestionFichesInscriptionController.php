...
class GestionFichesInscriptionController extends Controller
{
    ...
    public function Detail_Fiche_Insc(Request $request, $Fk_fiche, $id_prg, $id_hotel)
    {
        ...
        $Detail_Fiche_Insc = Gestion_detail_fiches_inscriptions::where('gestion_detail_fiches_inscriptions.deleted_at', '=', NULL)
            ...
            $Detail_facture = Gestion_detail_fiches_inscriptions::where('gestion_detail_fiches_inscriptions.deleted_at', '=', NULL)
...
// dd( $Detail_facture);
            ...
            // "num_ligne" => "20"
            // "nom_client" => "imane"
            // "prenom_client" => "ABDELAZIZ"
            // "nom_arabe" => "ايمان"
            // "prenom_arabe" => "ايمان"
            // "upload_img" => "1680773682_8360f6e8e6167d545b0c34de7490cc1e.jpg"
            // "num_GSM" => "0632122100"
            // "num_CIN" => "B367781"
            // "Email" => "imane@gmail.com"
            // "prix" => "256000"
            // "genre" => "1"
            // "num_passeport" => "CT1496506"
            // "date_naissance" => "1956-04-19"
            // "adresse" => "Mohamed 605"
            // "date_expiration" => "2023-04-25"
            // "situation_familiale" => "4"
            // "telephone" => "0633413354"
            // "date_obtention_visa" => "2027-10-14"
            // "num_visa" => "3"
            // "date_delivrance" => "2023-04-19"
            // "Province" => "undefined"
            // "date_expiration_visa" => "2030-01-20"
            // "etat_passeport" => "3"
            // "Num_Inscription" => "690"
            // "Type_visa" => null
            // "type_passport" => "P"
            // "Lieu_delivrance" => "2023-04-18"
            // "num_agence" => "11"
            // "img_pass" => "1680773682_dbc2eb0536332892433923c704a52330.jpg"
            // "FK_programme" => 1
            // "FK_type_chambre_makka" => 4
            // "FK_chambre_makka" => 6
            // "FK_type_chambre" => 11
            // "Fk_chambre_medina" => 6
            // "FK_accompagnateurs" => 2
            // "FK_inclus" => null
            // "Fk_fiche_inscription" => 1
            // "FK_detail_hotel_prg" => 3
            // "created_at" => "2023-04-06 09:34:42"
            // "updated_at" => "2023-04-06 11:42:23"
            // "deleted_at" => null

            $data=new Factures;
            $data->Code_client=  $Detail_facture->num_fichier;
        
        //    $data->numero_facture=  $Detail_Fiche_Ins->;
        //    $data->Numero_dossier=  $request->id_dossier;
           $data->bon_commande= $Detail_facture->bon_commande;
        //    $data->date=$request->input('date_fiche_inscription');
        //    $data->Vos_ref= $request->input('num_fichier');
           $data->Nom_client= $Detail_facture->nom_client;
           $data->adresse= $Detail_facture->adresse;
           $data->ville= $Detail_facture->Province;
        //    $data->Total= $request->input('num_fichier');
