...
Route::middleware('auth')->group(function () {
  ...
  Route::controller(PageController::class)->group(function () {
   ...
   Route::get('liste_Reglement', 'App\Http\Controllers\G_reglementController@liste_reglement')->name('liste_reglement');
   ...
   Route::GET('/generate_re/{num}','App\Http\Controllers\G_reglementController@print')->name('reglement');
   Route::get('/get_facture', 'App\Http\Controllers\G_reglementController@facture_info')->name('facture_info');
