...
<div class="top-bar">
    <!-- BEGIN: Breadcrumb -->
    <nav aria-label="breadcrumb" style="visibility: hidden;;"class="-intro-x mr-auto hidden sm:flex">
        <ol class="breadcrumb">
        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                <li class="p-2">
                    ...
                    <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">{{Auth::user()->phone}}</div>
                    <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">{{Auth::user()->privilege}}</div>
                </li>
