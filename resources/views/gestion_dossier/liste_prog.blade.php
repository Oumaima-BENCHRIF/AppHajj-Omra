            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible" style="overflow-x:auto;">
                ...
                <div class="intro-y box p-5 pt-10">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        ...
                        <a href="{{ Route('gestion_dossier.index') }}" title="Retour à la gestion des dossiers!" class="tooltip btn btn-primary w-1/2 sm:w-auto mr-10">
                        ...
                        <form id="tabulator-html-filter-form" class="xl:flex sm:ml-auto">
                            ...
                            <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                ...
                                <input id="tabulator-html-filter-value" type="text" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0 mr-2" placeholder="Search...">
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible" style="overflow-x:auto;">
                ...
                <div class="intro-y box p-5 pt-10">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        ...
                        <a href="{{ Route('gestion_dossier.index') }}" title="Retour à la gestion des dossiers!" class="mr-10 tooltip btn btn-primary sm:w-auto">
                            <span class="w-5 h-5 flex items-center justify-center">
                                <div class="col-span-6 sm:col-span-3 lg:col-span-2 xl:col-span-1">
                                    <i data-lucide="arrow-left" class="block mx-auto"></i>
                                </div>
