    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="whitespace-nowrap">IMAGESrrr</th>
                ...
                <tbody>
                    @foreach (array_slice($fakers, 0, 9) as $faker)
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{ $faker['categories'][0]['name'] }}</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Tags: {{ $faker['categories'][0]['tags'] }}</div>
                            </td>
                            <td>
                                <a class="text-slate-500 flex items-center mr-3" href="javascript:;">
                                    <i data-lucide="external-link" class="w-4 h-4 mr-2"></i> /categories/{{ $faker['categories'][0]['slug'] }}
                                </a>
                            </td>
                            <td class="w-40">
