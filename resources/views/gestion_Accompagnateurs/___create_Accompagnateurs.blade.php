...
@section('subhead')
<title>Gestion hotels transports</title>
@endsection
...
<!-- BEGIN: gestion hotels transports -->
<div class="intro-y box py-10 sm:py-20 mt-5">
    <div class="flex justify-center">
        ...
        <a title="listes hotels transports" class="intro-y w-10 h-10 rounded-full btn bg-slate-100 dark:bg-darkmode-400 dark:border-darkmode-400 text-slate-500 mx-2" href="{{ url('liste_Accompagnateurs') }}">2</a>
    </div>
